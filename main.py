...
parser.add_argument('--alpha', default=5, help='alpha step')
parser.add_argument('--count', default=100, help='count of detectors')
parser.add_argument('--span', default=1, help='span between detectors')
